   ...
   #+BEGIN_SRC emacs-lisp
     (use-package company
       ...
       (setq-default company-tooltip-limit 20                         ; bigger popup window
                     company-minimum-prefix-length 1                  ; WARNING, probably you will get perfomance issue if min len is 0!
       ...
       (add-hook 'prog-mode-hook
                 (lambda ()
                   (setq-local completion-at-point-functions
                               (list (cape-capf-super #'codeium-completion-at-point #'lsp-completion-at-point))))) ; try using codeium and lsp in prog modes
       )
   #+end_src
                  ...
                  (lambda ()
                    (setq-local completion-at-point-functions
                                (list (cape-capf-super
                                       #'codeium-completion-at-point #'cider-complete-at-point #'lsp-completion-at-point)))))
      #+END_SRC
