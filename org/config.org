...
** Eldoc box mode
   ...
   Add eldoc box mode for eldoc popups
...
*** org cycle if cursor at beginning of buffer
...
** Eglot
   ...
   Try Eglot instead of LSP.

   #+begin_src emacs-lisp
     (add-hook 'typescript-mode 'eglot-ensure)
     (add-hook 'typescript-ts-mode 'eglot-ensure)
     (defun set-eglot-mode-map ()         
       (define-key eglot-mode-map (kbd "C-c r") 'eglot-rename)
       (define-key eglot-mode-map (kbd "C-c C-o") 'eglot-code-action-organize-imports)
       (define-key eglot-mode-map (kbd "C-c h") 'eldoc))
     (add-hook 'eglot-managed-mode-hook 'set-eglot-mode-map)
   #+end_src
