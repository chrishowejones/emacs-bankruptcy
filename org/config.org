...
*** Erlang mode
    ...
    #+begin_src emacs-lisp
      (setq load-path (cons "~/.kerl/builds/27.3/otp_src_27.3/lib/tools/emacs" load-path))
      ...
      (use-package erlang :load-path
        ...
        (setq erlang-root-dir "~/.kerl/builds/27.2/otp_src_27.3/")
        ...
        :hook
        (my-paredit-nonlisp set-erlang-completion)
        )
    #+end_src
