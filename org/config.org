...
** command key as meta
   ...
   #+begin_src emacs-lisp
     (defun linux-mac-keyboard-remap()
       "Remap meta and super to suit an external Mac keyboard on a linux pc"
       (interactive)
...
*** Erlang mode
    ...
    #+begin_src emacs-lisp
      (setq load-path (cons "~/.kerl/builds/27.3.4/otp_src_27.3.4/lib/tools/emacs" load-path))
      ...
      (use-package erlang :load-path
        ("~/.kerl/builds/27.3.4/otp_src_27.3.4/lib/tools/emacs")
        :mode
        (("\\.erl?$" . erlang-mode)
        ...
        (setq erlang-root-dir "~/.kerl/builds/27.2/otp_src_27.3.4/")
        (setq exec-path (cons "~/.kerl/builds/27.3/otp_src_27.3.4/bin" exec-path))
        (setq erlang-man-root-dir "~/.kerl/builds/27.3/otp_src_27.3.4/man")
